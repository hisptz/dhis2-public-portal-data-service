    ...
    return (
        <div className="w-full h-full flex flex-col">
            <h1 className="font-bold">
                {i18n.t('Welcome to the Data Service!')}
            </h1>
            <p className="text-gray-500">
                {i18n.t(
                    'You can use this application to manage your data service configuration, view logs, and monitor the health of your data service.'
                )}
            </p>
